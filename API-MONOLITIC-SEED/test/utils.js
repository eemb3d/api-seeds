...
const { errors, dataManipulation } = require('../helpers/index');
...
describe('Test UTILS', () => {
    ...
    describe('DATA', () => {
        ...
        describe('fetch Local Games', () => {
            it('Fetch data from local: data has to be deep equal rowGameData', (done) => {
                dataManipulation.fetchLocal({ fileName: 'games.json' })
                    .then(res => {
        ...
        describe('fetch Local Report', () => {
            it('Fetch data from local: data has to be deep equal reportData', (done) => {
                dataManipulation.fetchLocal({ fileName: 'report.json' })
                    .then(res => {
